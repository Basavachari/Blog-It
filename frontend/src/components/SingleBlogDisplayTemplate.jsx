  ...
  return (
    <div key={blog._id} className='flex flex-col mt-[6%] w-9/12 ml-[10%] gap-y-10'>
      ...
      <div className='w-full'>
        <img alt='blogimage' className={`h-96 rounded-2xl ${blog.imageurl === null ? 'border-2 w-[45%] bg-[#f5f5fa]' : ''}`} src={blog.imageurl === null ? DEFAULT_BLOG_IMAGE :`https://res.cloudinary.com/djalm8jjs/image/upload/v${blog.imageurl}.png`} />
      </div>
